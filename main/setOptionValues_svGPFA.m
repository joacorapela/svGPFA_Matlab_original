...
if isfield(opts,'maxiter')
    ...
    if ~isfield(opts.maxiter,'inducingPointMstep')
        opts.maxiter.inducingPointMstep = 20;
    end
    ...
    opts.maxiter.hyperMstep = 10;  % number of hyper-Mstep iterations
...
% quadrature for link function if applicable
if ~isfield(opts,'nquad_link')
    opts.nquad_link = 20;
end

% size of minibatches
if ~isfield(opts,'nbatch')
    opts.nbatch = 5;
end
