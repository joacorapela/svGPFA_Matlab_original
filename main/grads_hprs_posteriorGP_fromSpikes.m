function [ddk_mu_hprs,ddk_sig_hprs] = grads_hprs_posteriorGP_fromSpikes(m,KmatsSpike,Kzzi,dKzzhprs,q_mu,q_sigma,trEval,numhprsPerK);
...
for k = 1:m.dx
    ...
    if nargout > 1
        ...
        for nn = 1:R
            ...
            sigggn{nn} =  bsxfun(@plus,KmatsSpike.dKtt{k,nn},ttm1 - ttm2);
        end
