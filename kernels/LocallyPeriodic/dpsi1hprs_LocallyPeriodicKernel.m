function dGhprs = dpsi1hprs_LocallyPeriodicKernel(prs,X1,mu,sigma,varargin)
...
dGhprs(:,:,2,:) = G .* (sigma/lengthscale^3 * 1./ ss + lengthscale * bsxfun(@times, ddist,1./(lengthscale^2 + sigma).^2));