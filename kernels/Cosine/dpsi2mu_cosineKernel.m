function dGmu = dpsi2mu_cosineKernel(prs,X1,mu,sigma,varargin)
...
dGmu = - variance^2./lengthscale^2 .* exp(-2*permute(sigma,[2 4 1 3])./lengthscale^4) .* sin(mudist./lengthscale^2);